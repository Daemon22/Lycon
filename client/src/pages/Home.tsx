      ...
      <main className="lycon-main">
        ...
        <div className="toolbar tablet-compact-toolbar">
          ...
          <form className="address-wrap" onSubmit={submitAddress}>
            ...
            <VoiceInputButton onTranscript={setAddress} onStatus={showToast} processLocally={voiceMode !== "online"} voskReady={voskPack.status === "ready"} />
          </form>
...
function VoiceInputButton({ onTranscript, onStatus, processLocally, voskReady }: { onTranscript: (value: string) => void; onStatus: (message: string) => void; processLocally: boolean; voskReady: boolean }) {
