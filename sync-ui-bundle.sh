...
rm -rf "$WIN_UI_DIR/assets/brands"
mkdir -p "$WIN_UI_DIR/assets/brands"
...
cp -r src/assets/brands/* "$WIN_UI_DIR/assets/brands/"
...
rm -rf "$ANDROID_UI_DIR/assets/brands"
mkdir -p "$ANDROID_UI_DIR/assets/brands"
...
cp -r src/assets/brands/* "$ANDROID_UI_DIR/assets/brands/"
